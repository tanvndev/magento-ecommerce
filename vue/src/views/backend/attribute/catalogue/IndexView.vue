...
// Data static
const pageTitle = 'Danh sách nhóm thuộc tính';
const modelName = 'AttributeCatalogue';
const routeCreate = 'attribute.catalogue.store';
const routeUpdate = 'attribute.catalogue.update';
