      ...
      <div class="container">
        ...
        <div class="sub-orders mb-10">
          ...
          <div class="alert alert-icon alert-inline mb-5">
            ...
            vendors. So we divided this order into multiple vendor orders. Each
            order will be handled by their respective vendor independently.
          </div>
                      ...
                      <tr class="email">
                        <td>
                          <a
                            ...
                            class="__cf_email__"
                            data-cfemail="9cf2f5fff9ebf3eef7adaea9dcfbf1fdf5f0b2fff3f1"
                            >[email&#160;protected]</a
                          >
                        </td>
                      </tr>
        ...
        <a href="#" class="btn btn-dark btn-rounded btn-icon-left btn-back mt-6"
